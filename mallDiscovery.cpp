...
{
    fstream read("sampleData.txt",ios::in);
...
void update_function(shop *shops, int count_of_shops){
    ofstream myfile("sampleData.txt");
    for(int i=0;i<count_of_shops;i++){
...
2;password2;croma;ground floor;electronics;subcategory;phones;samsung galaxy;15000;10;mi kt pro;34500;7;subcategory;laptops;hp pavilion;50000;10
